...
<body>
    ...
    <div class="slide">
        <div class="slideshow-container">
            <div class="mySlides fade">
                <img src="image/Untitled design1.svg" style="width:100%">
            </div>
            <div class="mySlides fade">
                <img src="image/Untitled design2.svg" style="width:100%">
            </div>
            <div class="mySlides fade">
                <img src="image/Untitled design3.svg" style="width:100%">
            </div>
    ...
    <div class="button1">
      ...
      <div class="register-form-container" id="registerForm">
          <form class="register-form-content" method="post" action="process.php" onsubmit="submitForm()">
      ...
      <section class="cards">
        <div class="card">
            <div class="card-img">
                <img src="image/MIM.svg" alt="Medicine 1">
            </div>
            <div class="card-content">
                <h3>Medicine Name</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin aliquam ex vel condimentum dignissim.</p>
                <a href="contact.html" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
            </div>
        </div>
        <div class="card">
            <div class="card-img">
                <img src="image/IBN SINA Hospital.svg" alt="Medicine 2">
            </div>
            <div class="card-content">
                <h3>Medicine Name</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin aliquam ex vel condimentum dignissim.</p>
        ...
        <div class="card">
            <div class="card-img">
                <img src="image/HEALTHY.svg" alt="Medicine 3">
            </div>
            <div class="card-content">
                <h3>Medicine Name</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin aliquam ex vel condimentum dignissim.</p>
